...
class GDListCongviec extends StatefulWidget {
  GDListCongviec({super.key});

  @override
  State<GDListCongviec> createState() => _GDListCongviecState();
}
...
// Timestamp.fromd
class _GDListCongviecState extends State<GDListCongviec> {
